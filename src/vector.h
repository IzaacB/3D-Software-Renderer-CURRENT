...
#define v2_mag(_a) ({ __typeof__(_a) __a = _a; (f32) sqrtf(__a.x * __a.x + __a.y * __a.y); })
#define v2_norm(_a) ({ __typeof__(_a) __a = _a; f32 _mag = v2_mag(_a); (v2) {__a.x / _mag, __a.y / _mag}; })
#define v2_dot(_a, _b) ({ __typeof__(_a) __a = _a, __b = _b; (f32) (__a.x * __b.x + __a.y * __b.y); })
...
#define v3_mag(_a) ({ __typeof__(_a) __a = _a; (f32) sqrtf(__a.x * __a.x + __a.y * __a.y + __a.z * __a.z); })
#define v3_norm(_a) ({ __typeof__(_a) __a = _a; f32 _mag = v3_mag(_a); (v3) {__a.x / _mag, __a.y / _mag, __a.z / _mag}; })
